...
// ADD a new product
router.post('/product/add', auth, fileMiddleware.single('img'), controllerAdmin.createProduct)

// Go to product EDIT page
router.get('/product/edit/:id', auth, controllerAdmin.getProductEditPage)

// EDIT a product
router.post('/product/edit/:id', auth, fileMiddleware.single('img'), controllerAdmin.updateProduct)
